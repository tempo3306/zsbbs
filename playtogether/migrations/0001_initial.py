# Generated by Django 2.0 on 2018-01-17 07:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='BilliardsInvite',
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('play_time', models.DateTimeField()),
                ('play_location', models.CharField(max_length=32)),
                ('play_type', models.CharField(max_length=32)),
                ('description', models.CharField(default='附近的球友一起来玩啦', max_length=32)),
                ('total_number', models.IntegerField(default=2)),
                ('currentuser_number', models.IntegerField(default=1)),
            ],
        ),
        migrations.CreateModel(
            name='BilliardsJoin',
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False)),
                ('invite', models.ManyToManyField(to='playtogether.BilliardsInvite')),
            ],
        ),
        migrations.CreateModel(
            name='BilliardsUser',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('level', models.CharField(choices=[('职业', '职业'), ('业余顶级', '业余顶级'), ('一般水平', '一般水平'), ('新手', '新手')], default=('一般水平', '一般水平'), max_length=32)),
                ('location', models.CharField(default='shanghai', max_length=32)),
                ('signature', models.CharField(default='新人驾到', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='playtogether', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('created',),
            },
        ...
        migrations.AddField(
            model_name='billiardsjoin',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='playtogether.BilliardsUser'),
        ),
        migrations.AddField(
            model_name='billiardsinvite',
            name='create_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='playtogether.BilliardsUser'),
        ),
    ]
